...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<float>("lio_sam/mappingDeskewedLeafSize", mappingDeskewedLeafSize, 0.2);
        ...
        nh.param<double>("rbf/cloud_downsapmle_leaf", cloud_downsapmle_leaf, 0.1);
        nh.param<double>("rbf/margin", margin, 0.5);
